...
#To do list GUI application is done by using tkinter library.where we can represent the tasks in visual representation and can easily able manage the tasks 
import tkinter
